...
<tr>
	<td class="pub_td1"><div class="teaser_img_div"><img class="teaser_img" src="/images/teasers/rlotsc.png"/></div></td>
	<td class="pub_td2"><b>RL-OTSC: A Reinforcement Learning-Assisted Framework for Continual Online Time Series Classification</b><br>
		<div class='paper_metadata'>
		<u>Junru Zhang</u>,
	  	Yang He,
	  	Zhidan Liu,
		Yipu Gong,
		Yabo Dong
		<br><i>Under review at IEEE Transactions on Knowledge and Data Engineering (TKDE) </i>,
		<br>TL;DR: A novel continual learning framework using RL for online time series classification, balancing stability and plasticity in challenging scenarios.<br>
		</div>
		[<a href="https://arxiv.org/abs/2310.05467">Paper</a>] [<a href="https://github.com/jrzhang33/TCE">Code</a>]
</td></tr>
{% include table-space.html %}
...
<tr>
	<td class="pub_td1"><div class="teaser_img_div"><a href="https://arxiv.org/abs/2310.05467"><img class="teaser_img" src="/images/teasers/2023_tce.png"/></a></div></td>
	<td class="pub_td2"><b>Temporal Convolutional Explorer Helps Understand 1D-CNN's Learning Behavior in Time Series Classification from Frequency Domain</b><br>
		<div class='paper_metadata'>
		<u>Junru Zhang</u>,
	  	Lang Feng,
	  	Yang He,
		Yuhan Wu,
		Yabo Dong
		<br><i>ACM International Conference on Information & Knowledge Management (CIKM) 2023</i>, long paper, accepted.
		<br>TL;DR: Explore the learning behavior of 1D-CNNs in TSC tasks and leverage this finding to correct the suboptimal behavior of 1D-CNNs.<br>
		</div>
		[<a href="https://arxiv.org/abs/2310.05467">Paper</a>] [<a href="https://github.com/jrzhang33/TCE">Code</a>]
</td></tr>
{% include table-space.html %}
...
<tr>
	<td class="pub_td1"><div class="teaser_img_div"><a href="https://link.springer.com/chapter/10.1007/978-3-031-43424-2_12"><img class="teaser_img" src="/images/teasers/2023_adacket.png"/></a></div></td>
	<td class="pub_td2"><b>Adacket: ADAptive Convolutional KErnel Transform for Multivariate Time Series Classification</b><br>
		<div class='paper_metadata'>
		<u>Junru Zhang</u>,
	  	Lang Feng,
	  	Haowen Zhang,
		Yuhan Wu,
		Yabo Dong
		<br><i>European Conference on Machine Learning and Principles and Practice of Knowledge Discovery in Databases (ECML-PKDD) 2023</i>, accepted.
		<br>TL;DR: An adaptive convolutional kernel transform that models the establishment of 1D-CNN as a sequential decision-making problem using the reinforcement learning.<br>
		</div>
	[<a href="https://link.springer.com/chapter/10.1007/978-3-031-43424-2_12">Paper</a>] [<a href="https://github.com/jrzhang33/Adacket">Code</a>][<a href="/images/teasers/Slide_Sub754-Adacket-J. Zhang.pdf">Slide</a>] [<a href="/images/teasers/Poster-Sub754-Adacket-J. Zhang.pdf">Poster</a>]
</td></tr>
{% include table-space.html %}


<tr>
	<td class="pub_td1"><div class="teaser_img_div"><img class="teaser_img" src="/images/teasers/icassp.png"/></div></td>
	<td class="pub_td2"><b>HFLA: A Method To Enhance CNN'S High-Frequency Information Learning For Time Series Classification</b><br>
		<div class='paper_metadata'>
		Yang He,
		<u>Junru Zhang</u>,
	  	Yuhan Wu,
	  	Yabo Dong
		<br><i>Under review at IEEE International Conference on Acoustics, Speech and Signal Processing (ICASSP) 2024 </i>,
		<br>TL;DR: Leverage multi-level wavelet transform to address the CNN's learning of high-frequency information in time series.<br>
		</div>
